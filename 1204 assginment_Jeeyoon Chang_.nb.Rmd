---
title: "1204assignment_Jeeyoon_Chang"
...
The correlation coefficient is defined for a list of pairs  
  as the average of the product of the standardized values:
```{r}
...
ρ
 , here are six examples of pairs with correlations ranging from -0.9 to 0.99:
...
In our example,  
N=25
  does not seem to be large enough to make the approximation a good one:
```{r}
